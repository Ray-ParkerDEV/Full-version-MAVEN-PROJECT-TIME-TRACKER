...
public class QueriesDB {
    ...
    public static final String UPDATE_USER_TYPE_BY_ID = "UPDATE user_type SET user_type_name=? WHERE id=?;";
    ...
    public static final String UPDATE_ACTIVITY_BY_ID = "UPDATE activity SET activity_name=? WHERE id=?;";
    ...
    public static final String GET_TRACKING_BY_ID = "SELECT * FROM tracking \n" +
            "JOIN user ON tracking.user_id = user.id\n" +
            "JOIN user_request ON tracking.user_request_id = user_request.id\n" +
    ...
    public static final String GET_ALL_TRACKING_BY_CLIENT_ID = "SELECT * FROM tracking \n" +
            ...
            "JOIN status ON tracking.status_id = status.id \n" +
            "JOIN activity ON tracking.activity_id = activity.id\n" +
            "JOIN user_type ON user.user_type_id = user_type.id WHERE user_id = ?";
